...
twiggy is a base Extra template that is useful when wanting to create a new
...
`git clone http://github.com/splittingred/twiggy.git ./`

Then, create the target directory where you want to create the file.

Then, navigate to the directory twiggy is now in, and do this:
...
Now, you'll want to change references to twiggy in the files in your
new copied-from-twiggy repo to whatever name of your new Extra will be. Once
...
Also, you'll want to change all the references of 'twiggy' to whatever the
name of your component is.

## Copyright Information

twiggy is distributed as GPL (as MODx Revolution is), but the copyright owner
(Shaun McCormick) grants all users of twiggy the ability to modify, distribute
and use twiggy in MODx development as they see fit, as long as attribution
